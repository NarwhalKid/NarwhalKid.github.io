...
<link rel="stylesheet" href="css/style.css"><link rel="stylesheet" href="css/basic page.css"><script src="scripts/game.js"></script>
</head>
<body onload="setup();">
<div id="page-area-container">
<div id="page-area">
<div class="title">Tetresse - Practice Tool</div>
<div id="play-area">
<div class="game"></div>
</div>
<table id="stats">
