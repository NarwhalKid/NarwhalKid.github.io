...
function preload() {
    ...
    idleImage = loadImage('images/posesOriginal/idle.png')
    squatImage = loadImage('images/posesOriginal/squat.png')
    jumpImage = loadImage('images/posesOriginal/jump.png')
    oofImage = loadImage('images/posesOriginal/oof.png')
    run1Image = loadImage('images/posesOriginal/run1.png')
    run2Image = loadImage('images/posesOriginal/run2.png')
    run3Image = loadImage('images/posesOriginal/run3.png')
    fallenImage = loadImage('images/posesOriginal/fallen.png')
    fallImage = loadImage('images/posesOriginal/fall.png')
