...
aiptag.settings = {
	sVersion: '2.0',
	sUpdated: 'Monday 13 December 2021 - 13:36',
	sPubName: 'TTI',
	sSellerId: 'TTI',
	sPubUrl: 'tetr.io',
	sAdUnitVideo: '',
	...
	sNetworkIdRewarded: '421469808,22431394745',
	...
	iMCMiD: '22431394745',
	iAmazonAds: false,
	sNetworkIdVideo: '421469808,22431394745',
	sNetworkIdDisplay: '421469808,22431394745',
	iAdFading: true,
	iDFPAdSlots: true,
...
function aipAPI() {
	...
	*/
	...
	if(aiptag.settings.iVideoAdUnitBidders) {
		...
		this.videoAdUnit[""] = {};this.videoAdUnitMaxDuration[""] = "30000";	}

			this.adUnits['tetr-io_300x250_1'] = [{
		code: 'tetr-io_300x250_1',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		this.adSlots['tetr-io_300x250_1'] = {adunit: 'tetr.io_300x250_1', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_300x250_1'] = [{slotID: 'tetr-io_300x250_1', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_300x250_1', sizes: [[300, 250]]}];
		}
		this.requestManager['tetr-io_300x250_1'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_1'] = [{
		code: 'tetr-io_728x90_1',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_1'] = {adunit: 'tetr.io_728x90_1', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_1'] = [{slotID: 'tetr-io_728x90_1', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_1', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_1'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_2'] = [{
		code: 'tetr-io_728x90_2',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_2'] = {adunit: 'tetr.io_728x90_2', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_2'] = [{slotID: 'tetr-io_728x90_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_2', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_2'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_3'] = [{
		code: 'tetr-io_728x90_3',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_3'] = {adunit: 'tetr.io_728x90_3', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_3'] = [{slotID: 'tetr-io_728x90_3', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_3', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_3'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_4'] = [{
		code: 'tetr-io_728x90_4',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_4'] = {adunit: 'tetr.io_728x90_4', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_4'] = [{slotID: 'tetr-io_728x90_4', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_4', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_4'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_5'] = [{
		code: 'tetr-io_728x90_5',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_5'] = {adunit: 'tetr.io_728x90_5', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_5'] = [{slotID: 'tetr-io_728x90_5', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_5', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_5'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_6'] = [{
		code: 'tetr-io_728x90_6',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_6'] = {adunit: 'tetr.io_728x90_6', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_6'] = [{slotID: 'tetr-io_728x90_6', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_6', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_6'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_7'] = [{
		code: 'tetr-io_728x90_7',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_7'] = {adunit: 'tetr.io_728x90_7', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_7'] = [{slotID: 'tetr-io_728x90_7', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_7', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_7'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_8'] = [{
		code: 'tetr-io_728x90_8',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_8'] = {adunit: 'tetr.io_728x90_8', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_8'] = [{slotID: 'tetr-io_728x90_8', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_8', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_8'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_728x90_9'] = [{
		code: 'tetr-io_728x90_9',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		this.adSlots['tetr-io_728x90_9'] = {adunit: 'tetr.io_728x90_9', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_728x90_9'] = [{slotID: 'tetr-io_728x90_9', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_728x90_9', sizes: [[728, 90]]}];
		}
		this.requestManager['tetr-io_728x90_9'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_970X250_1'] = [{
		code: 'tetr-io_970X250_1',
		mediaTypes: {
			banner: {
				sizes: [970, 250]
			}
		...
		this.adSlots['tetr-io_970X250_1'] = {adunit: 'tetr.io_970X250_1', sizes: [970, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_970X250_1'] = [{slotID: 'tetr-io_970X250_1', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_970X250_1', sizes: [[970, 250]]}];
		}
		this.requestManager['tetr-io_970X250_1'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_970X250_2'] = [{
		code: 'tetr-io_970X250_2',
		mediaTypes: {
			banner: {
				sizes: [970, 250]
			}
		...
		this.adSlots['tetr-io_970X250_2'] = {adunit: 'tetr.io_970X250_2', sizes: [970, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_970X250_2'] = [{slotID: 'tetr-io_970X250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_970X250_2', sizes: [[970, 250]]}];
		}
		this.requestManager['tetr-io_970X250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['tetr-io_300X600'] = [{
		code: 'tetr-io_300X600',
		mediaTypes: {
			banner: {
				sizes: [300, 600]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: {
					placementId: '20796302'
				}
			},
			{	
				bidder: 'cpmstar',
				params: { placementId: '81290' }
			},
			{
				bidder: 'pubmatic',
				params: {
					publisherId: '156857',
					adSlot: '3451745@300x600'
				}
			},
			{
				bidder: 'openx',
		...
		this.adSlots['tetr-io_300X600'] = {adunit: 'tetr.io_300X600', sizes: [300, 600], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['tetr-io_300X600'] = [{slotID: 'tetr-io_300X600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/tetr.io_300X600', sizes: [[300, 600]]}];
		}
		this.requestManager['tetr-io_300X600'] = {adserverRequestSent: false, aps: false, prebid: false};
	...
	*/
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['tetr-io_300x250_1'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_1'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_3'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_4'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_5'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_6'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_7'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_8'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_728x90_9'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_970X250_1'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_970X250_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['tetr-io_300X600'], aRemoveBidders);
...
aipAPI.prototype.cutomSizeConfig = function() {
		try {
		this.adSlots['tetr-io_970X250_1']['sizes'] = [[970, 250], [970, 90], [728, 90], [300, 250]];
		this.adUnits['tetr-io_970X250_1'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [728, 90], [300, 250]];
		aipAPItag.addBidder('tetr-io_970X250_1',{bidder: 'ix',	params: { siteId: '638072', size: [970, 90] }});
		aipAPItag.addBidder('tetr-io_970X250_1',{bidder: 'ix',	params: { siteId: '638072', size: [728, 90] }});
		aipAPItag.addBidder('tetr-io_970X250_1',{bidder: 'ix',	params: { siteId: '638072', size: [300, 250] }});
		
		this.adSlots['tetr-io_970X250_2']['sizes'] = [[970, 250], [970, 90], [728, 90], [300, 250]];
		this.adUnits['tetr-io_970X250_2'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [728, 90], [300, 250]];
		aipAPItag.addBidder('tetr-io_970X250_2',{bidder: 'ix',	params: { siteId: '637996', size: [970, 90] }});
		aipAPItag.addBidder('tetr-io_970X250_2',{bidder: 'ix',	params: { siteId: '637996', size: [728, 90] }});
		aipAPItag.addBidder('tetr-io_970X250_2',{bidder: 'ix',	params: { siteId: '637996', size: [300, 250] }});
		
		this.adSlots['tetr-io_300X600']['sizes'] = [[300, 600], [300, 250], [120, 600], [160, 600]];
		this.adUnits['tetr-io_300X600'][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [300, 250], [120, 600], [160, 600]];
		aipAPItag.addBidder('tetr-io_300X600',{bidder: 'ix',	params: { siteId: '638082', size: [300, 250] }});
		aipAPItag.addBidder('tetr-io_300X600',{bidder: 'ix',	params: { siteId: '638082', size: [120, 600] }});
		aipAPItag.addBidder('tetr-io_300X600',{bidder: 'ix',	params: { siteId: '638082', size: [160, 600] }});
	} catch(e) {}aipAPItag.log("cutomSizeConfig set");}



var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(a){var c=0;return function(){return c<a.length?{done:!1,value:a[c++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.makeIterator=function(a){var c="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];return c?c.call(a):$jscomp.arrayIterator(a)};
aiptag.settings.iAmazonAds&&!function(a,c,b,d,f,g,p){c[a]||(c[a]={init:function(){c[a]._Q.push(["i",arguments])},fetchBids:function(){c[a]._Q.push(["f",arguments])},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]},g=b.createElement(d),g.async=!0,g.src=f,p=b.getElementsByTagName(d)[0],p.parentNode.insertBefore(g,p))}("apstag",window,document,"script","//c.amazon-adsystem.com/aax2/apstag.js");
...
function cmp_getlang(a){"boolean"!=typeof a&&(a=!0);if(a&&"string"==typeof cmp_getlang.usedlang&&""!==cmp_getlang.usedlang)return cmp_getlang.usedlang;a="DE EN FR IT NO DA FI ES PT RO BG ET EL GA HR LV LT MT NL PL SV SK SL CS HU RU SR ZH TR UK".split(" ");var c=[],b=location.hash,d=location.search,f="languages"in navigator?navigator.languages:[];if(-1!=b.indexOf("cmplang="))c.push(b.substr(b.indexOf("cmplang=")+8,2));else if(-1!=d.indexOf("cmplang="))c.push(d.substr(d.indexOf("cmplang=")+8,2));else if("cmp_setlang"in
window&&""!=window.cmp_setlang)c.push(window.cmp_setlang.toUpperCase());else if(0<f.length)for(b=0;b<f.length;b++)c.push(f[b]);"language"in navigator&&c.push(navigator.language);"userLanguage"in navigator&&c.push(navigator.userLanguage);f="";for(b=0;b<c.length;b++)if(d=c[b].toUpperCase(),-1!=d.indexOf("-")&&(d=d.substr(0,2)),-1!=a.indexOf(d)){f=d;break}if(""==f&&"string"==typeof cmp_getlang.defaultlang&&""!==cmp_getlang.defaultlang)return cmp_getlang.defaultlang;""==f&&(f="EN");return f=f.toUpperCase()}
aipAPI.prototype.initGDPR=function(){function a(f,g,p,m,h){"undefined"===typeof h&&(h="/");"undefined"===typeof m?(m=(window&&window.location&&window.location.hostname||"").split("."),m=";domain="+(1<m.length?m.slice(-2).join("."):"")):m="";var n=new Date;n.setSeconds(n.getSeconds()+p);document.cookie=f+" = "+g+m+";path="+h+";max-age="+p+";Expires="+n.toUTCString()}function c(){aipAPItag.start();try{var f=new CustomEvent("aip_consentnotrequired");document.dispatchEvent(f)}catch(g){aipAPItag.logError(g)}}
function b(){aip_pbjs.setConfig({consentManagement:{gdpr:{cmpApi:"iab",timeout:8E3,allowAuctionWithoutConsent:!0,defaultGdprScope:!0}}});aipAPItag.CMPloadTimeout=setTimeout(function(){aipAPItag.log("AIP Ads started after CMP timeout");aipAPItag.start()},aipAPItag.timeout_cmp);var f=document.createElement("link");f.type="text/css";f.rel="stylesheet";f.async=!0;f.href="https://cdn.consentmanager.mgr.consensu.org/delivery/cmp.min.css";document.getElementsByTagName("head")[0].appendChild(f);window.cmp_id=
"bottom"===aiptag.cmp.position?15920:13566;window.gdprAppliesGlobally=!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_host="consentmanager.mgr.consensu.org";window.cmp_logoclick="https://adinplay.com/?utm_source=publishers&utm_medium=cmp";window.cmp_cdn="cdn.consentmanager.mgr.consensu.org";(function(){var g="",p="_en";"cmp_getlang"in window&&(g=window.cmp_getlang().toLowerCase(),p="_"+g);var m=document.createElement("script");m.src="https://"+window.cmp_host+"/delivery/cmp.php?id="+
window.cmp_id+"&h="+encodeURIComponent(location.href)+"&"+window.cmp_params+(0<document.cookie.length?"&__cmpfcc=1":"")+"&l="+g+"&o="+(new Date).getTime();m.type="text/javascript";m.setAttribute("data-cmp-ab","1");m.async=!0;document.body?document.body.appendChild(m):document.currentScript?document.currentScript.parentElement.appendChild(m):document.write(m.outerHTML);m=document.createElement("script");m.src="https://"+window.cmp_cdn+"/delivery/cmp"+p+".min.js";m.type="text/javascript";m.setAttribute("data-cmp-ab",
"1");m.async=!0;document.body?document.body.appendChild(m):document.currentScript?document.currentScript.parentElement.appendChild(m):document.write(m.outerHTML);window.cmp_addFrame=function(h){if(!window.frames[h])if(document.body){var n=document.createElement("iframe");n.style.cssText="display:none";n.name=h;document.body.appendChild(n)}else window.setTimeout('window.cmp_addFrame("'+h+'")',10)};window.cmp_rc=function(h){for(var n=document.cookie,t="",u=0;""!=n&&100>u;){for(u++;" "==n.substr(0,1);)n=
n.substr(1,n.length);var v=n.substring(0,n.indexOf("=")),y=-1!=n.indexOf(";")?n.substring(n.indexOf("=")+1,n.indexOf(";")):n.substr(n.indexOf("=")+1,n.length);h==v&&(t=y);v=n.indexOf(";")+1;0==v&&(v=n.length);n=n.substring(v,n.length)}return t};window.cmp_stub=function(){var h=arguments;__cmapi.a=__cmapi.a||[];if(h.length)if("ping"===h[0])if(2===h[1])h[2]({gdprApplies:gdprAppliesGlobally,cmpLoaded:!1,cmpStatus:"stub",displayStatus:"hidden",apiVersion:"2.0",cmpId:31},!0);else h[2]({gdprAppliesGlobally:gdprAppliesGlobally,
cmpLoaded:!1},!0);else if("getUSPData"===h[0])h[2]({version:1,uspString:window.cmp_rc("")},!0);else if("getTCData"===h[0])__cmapi.a.push([].slice.apply(h));else if("addEventListener"===h[0])__cmapi.a.push([].slice.apply(h));else if(4==h.length&&!1===h[3])h[2]({},!1);else __cmapi.a.push([].slice.apply(h));else return __cmapi.a};window.cmp_msghandler=function(h){var n="string"===typeof h.data;try{var t=n?JSON.parse(h.data):h.data}catch(v){t=null}if("object"===typeof t&&null!==t&&"__cmpCall"in t){var u=
t.__cmpCall;window.__cmp(u.command,u.parameter,function(v,y){var x={__cmpReturn:{returnValue:v,success:y,callId:u.callId}};h.source.postMessage(n?JSON.stringify(x):x,"*")})}"object"===typeof t&&null!==t&&"__cmapiCall"in t&&(u=t.__cmapiCall,window.__cmapi(u.command,u.parameter,function(v,y){var x={__cmapiReturn:{returnValue:v,success:y,callId:u.callId}};h.source.postMessage(n?JSON.stringify(x):x,"*")}));"object"===typeof t&&null!==t&&"__uspapiCall"in t&&(u=t.__uspapiCall,window.__uspapi(u.command,
u.version,function(v,y){var x={__uspapiReturn:{returnValue:v,success:y,callId:u.callId}};h.source.postMessage(n?JSON.stringify(x):x,"*")}));"object"===typeof t&&null!==t&&"__tcfapiCall"in t&&(u=t.__tcfapiCall,window.__tcfapi(u.command,u.version,function(v,y){var x={__tcfapiReturn:{returnValue:v,success:y,callId:u.callId}};h.source.postMessage(n?JSON.stringify(x):x,"*")},u.parameter))};window.cmp_setStub=function(h){h in window&&("function"===typeof window[h]||"object"===typeof window[h]||"undefined"!==
typeof window[h]&&null===window[h])||(window[h]=window.cmp_stub,window[h].msgHandler=window.cmp_msghandler,window.addEventListener?window.addEventListener("message",window.cmp_msghandler,!1):window.attachEvent("onmessage",window.cmp_msghandler))};window.cmp_addFrame("__cmapiLocator");window.cmp_addFrame("__cmpLocator");window.cmp_addFrame("__uspapiLocator");window.cmp_addFrame("__tcfapiLocator");window.cmp_setStub("__cmapi");window.cmp_setStub("__cmp");window.cmp_setStub("__tcfapi");window.cmp_setStub("__uspapi")})();
__cmp("addEventListener",["consent",function(g,p){aipAPItag.log("AIP Ads started after consent");aipAPItag.start();var m="Privacy settings";aiptag.cmp.buttonText&&(m=aiptag.cmp.buttonText);var h="none";!0===aiptag.cmp.button&&(h="block");var n="bottom: 0px;left: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;";"bottom-right"==aiptag.cmp.buttonPosition&&(n="bottom: 0px;right: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;");"top-right"==aiptag.cmp.buttonPosition&&(n="top: 0px;right: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");
"top-left"==aiptag.cmp.buttonPosition&&(n="top: 0px;left: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");try{if(!aipAPItag.isInPage(document.getElementById("cmpPersistentLink"))){var t=document.createElement("div");document.getElementsByTagName("body")[0].appendChild(t);t.id="cmpPersistentLink";t.style.display=h;t.innerHTML='<a href="#" onclick="aipAPItag.showCMPScreen();return false;" class="cmp-persistent-link" style="text-decoration: none;cursor: pointer; position: fixed; background-color: #1f83be; padding: 5px 15px; color: #ffffff; display: flex; max-height: 30px; z-index: 999994;'+
n+'"><svg width="16px" height="17px" viewBox="0 0 16 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-right: 5px; height: 17px;"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="cog" fill="#FFFFFF" fill-rule="nonzero"><path d="M15.596917,9.98326938 L14.5041079,9.33798816 C14.5728064,8.7815386 14.5728064,8.2184614 14.5041079,7.66201184 L15.596917,7.01673062 C15.9178229,6.82726259 16.0726124,6.43742732 15.9670848,6.0741546 C15.5912871,4.78033611 14.9223646,3.61573153 14.0390021,2.66061113 C13.7831755,2.38401797 13.3749053,2.32348965 13.0525249,2.51384881 L11.9613243,3.15813608 C11.5248519,2.81840117 11.0481221,2.53648663 10.542482,2.31910255 L10.542482,1.02991108 C10.542482,0.648438733 10.2860522,0.316869683 9.92305592,0.229024792 C8.66155,-0.07632446 7.33871809,-0.0763587342 6.07694408,0.229024792 C5.71398131,0.316869683 5.457518,0.648404458 5.457518,1.02991108 L5.457518,2.31910255 C4.95187406,2.53647872 4.47514334,2.81839382 4.03867572,3.15813608 L2.94747511,2.51384881 C2.62506122,2.32348965 2.21679094,2.38401797 1.96099786,2.66061113 C1.07763542,3.61573153 0.40871289,4.78037038 0.0329152236,6.0741546 C-0.072612407,6.43742732 0.0821770899,6.82722832 0.403082962,7.01673062 L1.49589212,7.66201184 C1.42719356,8.2184614 1.42719356,8.7815386 1.49589212,9.33798816 L0.403082962,9.98326938 C0.0821770899,10.1727374 -0.072612407,10.5625727 0.0329152236,10.9258454 C0.40871289,12.2196296 1.07763542,13.3842685 1.96099786,14.3393889 C2.21682445,14.615982 2.62509474,14.6765103 2.94747511,14.4861855 L4.03867572,13.8418982 C4.47514096,14.1816349 4.95187243,14.4635389 5.457518,14.6808975 L5.457518,15.9700889 C5.457518,16.3515613 5.7139478,16.6831303 6.07694408,16.7709752 C7.33848351,17.0763245 8.66128191,17.0763587 9.92305592,16.7709752 C10.2860187,16.6831303 10.542482,16.3515955 10.542482,15.9700889 L10.542482,14.6808975 C11.0481183,14.4635198 11.5248475,14.1816171 11.9613243,13.8418982 L13.0525249,14.4861855 C13.3749053,14.6765446 13.7831755,14.6160163 14.0390021,14.3393889 C14.9223646,13.3842685 15.5912871,12.2196296 15.9670848,10.9258454 C16.0726124,10.5625727 15.9178229,10.1727717 15.596917,9.98326938 Z M13.4026193,13.4264943 L11.8507364,12.510001 C10.9463288,13.3007421 10.6255905,13.4997041 9.47011484,13.9172673 L9.47011484,15.7502196 C8.50024808,15.9548373 7.49975192,15.9548373 6.52988516,15.7502196 L6.52988516,13.9172673 C5.4031959,13.5101235 5.07699522,13.3210668 4.14926358,12.510001 L2.59738075,13.4264943 C1.9368696,12.6693763 1.43490124,11.7817076 1.12525522,10.8230912 L2.67780828,9.90659789 C2.4588108,8.69270694 2.45871027,8.30790999 2.67780828,7.09340211 L1.12525522,6.17690879 C1.43490124,5.21829242 1.93690311,4.33058946 2.59738075,3.57312864 L4.14926358,4.49030745 C5.0667072,3.68712478 5.39129933,3.4941265 6.52988516,3.08269846 L6.52988516,1.24978037 C7.49971774,1.04482059 8.50028226,1.04482059 9.47011484,1.24978037 L9.47011484,3.08273274 C10.6087677,3.49419505 10.9333933,3.6872276 11.8507364,4.49034172 L13.4026193,3.57316291 C14.0630969,4.33058946 14.5650988,5.21829242 14.8747448,6.17694306 L13.3221917,7.09343638 C13.5412227,8.3076358 13.5412897,8.69212428 13.3221917,9.90663217 L14.8747448,10.8231255 C14.5650988,11.7817076 14.0631304,12.6694105 13.4026193,13.4264943 Z M8,5.20968958 C6.22607014,5.20968958 4.78289853,6.68570996 4.78289853,8.50001714 C4.78289853,10.3143243 6.22607014,11.7903447 8,11.7903447 C9.77392986,11.7903447 11.2171015,10.3143243 11.2171015,8.50001714 C11.2171015,6.68570996 9.77392986,5.20968958 8,5.20968958 Z M8,10.6935688 C6.81738009,10.6935688 5.85526568,9.70955526 5.85526568,8.50001714 C5.85526568,7.29047902 6.81738009,6.30646543 8,6.30646543 C9.18261991,6.30646543 10.1447343,7.29047902 10.1447343,8.50001714 C10.1447343,9.70955526 9.18261991,10.6935688 8,10.6935688 Z" id="Shape"></path></g></g></svg>'+
m+"</a>"}}catch(B){aipAPItag.logError(B)}try{var u=new CustomEvent("aip_consent",{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(u);var v=__cmp("getCMPData");if("vendorConsents"in v)if("755"in v.vendorConsents&&v.vendorConsents["755"])try{var y=new CustomEvent("aip_consentapproved",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(y)}catch(B){aipAPItag.logError(B)}else try{var x=new CustomEvent("aip_consentrejected",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(x)}catch(B){aipAPItag.logError(B)}}catch(B){aipAPItag.logError(B)}},
!1],null);__cmp("addEventListener",["init",function(g,p){try{var m=new CustomEvent("aip_consentinit",{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(m)}catch(h){aipAPItag.logError(h)}},!1],null);__cmp("addEventListener",["settings",function(g,p){try{clearTimeout(aipAPItag.CMPloadTimeout)}catch(h){aipAPItag.logError(h)}try{var m=new CustomEvent("aip_consentsettings",{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(m)}catch(h){aipAPItag.logError(h)}},!1],null);__cmp("addEventListener",
["consentscreen",function(g,p){try{var m=new CustomEvent("aip_consentscreen",{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(m)}catch(h){aipAPItag.logError(h)}},!1],null);__cmp("addEventListener",["consentscreenoff",function(g,p){try{var m=new CustomEvent("aip_consentscreenoff",{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(m)}catch(h){aipAPItag.logError(h)}},!1],null);__cmp("addEventListener",["liestablished",function(g,p){try{var m=new CustomEvent("aip_consentliestablished",
{detail:{eventname:g,cmpobject:p}});document.dispatchEvent(m)}catch(h){aipAPItag.logError(h)}},!1],null)}if(!0===aiptag.cmp.show)if(aipAPItag.log("aiptag.cmp.show = true"),"true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),b();else if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, GDPR Consent not required"),c();else{var d=new XMLHttpRequest;d.onreadystatechange=function(){if(d.readyState==
XMLHttpRequest.DONE)if(200==d.status){var f="";try{f=d.responseText.toUpperCase()}catch(g){aipAPItag.logError(g)}a("CountryCode",f,"7889229");aipAPItag.CountryCode=f;0<="AT AX BE BG CY CZ DE DK EE EL ES EU FI FR GB GF GI GP GR HR HU IE IS IT LI LT LU LV ME MF MQ MT NL NO PL PT RE RO SE SI SK YT UK".split(" ").indexOf(f)?(a("userFromEEA","true","7889229"),aipAPItag.userFromEEA="true",aipAPItag.log("GDPR Consent required for "+f),b()):(a("userFromEEA","false","7889229"),aipAPItag.userFromEEA="false",
aipAPItag.log("GDPR Consent not required for "+f),c())}else aipAPItag.log("Unknown geo-targeting issue, assuming user from EEA"),aipAPItag.userFromEEA="true",b()};d.ontimeout=function(f){aipAPItag.log("Geo-targeting timeout occured, assuming user from EEA");aipAPItag.userFromEEA="true";b()};d.open("GET","https://country.adinplay.workers.dev/",!0);d.timeout=1500;d.send()}else aipAPItag.log("aiptag.cmp.show = false, or not set"),c()};aipAPI.prototype.showCMPScreen=function(){try{window.__cmp("showGDPRScreen")}catch(a){}};
...
aipAPI.prototype.urlParamUpdate=function(a,c,b,d){var f=new RegExp("[\\?&]"+c+"=([^&#]*)","i"),g=f.exec(a);if(null===g)d=/\?/.test(a),a=a+(d?"&":"?")+c+"="+b;else{var p=g[0].charAt(0);a=!0===d?a.replace(f,p+c+"="+g[1]+"%26"+b):a.replace(f,p+c+"="+b)}return a};
...
aipAPI.prototype.getScript=function(a,c){var b=document.head||document.getElementsByTagName("head")[0],d=document.createElement("script"),f=!0;d.async=!0;d.type="text/javascript";d.charset="UTF-8";d.src=a;d.onerror=d.onload=d.onreadystatechange=function(){!f||d.readyState&&!/loaded|complete/.test(d.readyState)||(f=!1,c(),d.onerror=d.onload=d.onreadystatechange=null)};b.appendChild(d)};
...
aipAPI.prototype.wait=function(a,c,b,d,f){var g=0,p=function(){g+=a;b()?d():g>=c?f():setTimeout(p,a)};p()};aipAPI.prototype.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};aipAPI.prototype.forceRedraw=function(a){if(a){var c=document.createTextNode(" "),b=a.style.display;a.appendChild(c);a.style.display="none";setTimeout(function(){a.style.display=b;c.parentNode.removeChild(c)},20);aipAPItag.log("forceRedraw")}};
aipAPI.prototype.inArray=function(a,c){for(var b=0,d=0,f=c.length;d<f;d++){if(c[d]==a)return d;b++}return-1};aipAPI.prototype.deepEqual=function(a,c){var b=Object.keys(a),d=Object.keys(c);if(b.length!==d.length)return!1;b=$jscomp.makeIterator(b);for(d=b.next();!d.done;d=b.next()){var f=d.value;d=a[f];f=c[f];var g=aipAPItag.isObject(d)&&aipAPItag.isObject(f);if(g&&!aipAPItag.deepEqual(d,f)||!g&&d!==f)return!1}return!0};aipAPI.prototype.isObject=function(a){return null!=a&&"object"===typeof a};
...
aipAPI.prototype.getAllBids=function(){(function(){function a(f,g){Object.keys(f).forEach(function(p){f[p].bids.forEach(function(m){g(p,m)})})}var c=aip_pbjs.getAllWinningBids(),b=[];a(aip_pbjs.getBidResponses(),function(f,g){b.push({bid:g,adunit:f,adId:g.adId,bidder:g.bidder,time:g.timeToRespond,cpm:g.cpm,msg:g.statusMessage,rendered:!!c.find(function(p){return p.adId==g.adId})})});a(aip_pbjs.getNoBids&&aip_pbjs.getNoBids()||{},function(f,g){b.push({msg:"no bid",adunit:f,adId:g.bidId,bidder:g.bidder})});
...
aipAPI.prototype.removeBidders=function(a,c){try{a.forEach(function(b,d){var f=b.bids,g=[];f&&0<f.length&&f.forEach(function(p,m){-1===c.indexOf(p.bidder)&&g.push(p)});a[d].bids=g})}catch(b){aipAPItag.logError(b)}};
...
aipAPItag.log("slotRenderEnded: "+a.slot.getSlotElementId());aipAPItag.log(a)}catch(b){aipAPItag.logError(b)}})})),aiptag.settings.sAdUnitVideo||aiptag.settings.sRewardedAdUnitVideo)&&(aiptag.settings.sRewardedAdUnitVideo&&!aiptag.settings.sAdUnitVideo?aipAPItag.initPlayerTag():aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//imasdk.googleapis.com/js/sdkloader/ima3.js",function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)}))};
function aipDisplay(){}
...
aipDisplay.prototype.displaySetup=function(a){aip_pbjs.que.push(function(){aipAPItag.displayBidCpm.rhythmone=.8;aipAPItag.displayBidCpm.unruly=.87;aipAPItag.displayBidCpm.rubicon=.75;if(aiptag.settings.sCustomDisplayBidCpmAdjustment){var c=aiptag.settings.sCustomDisplayBidCpmAdjustment;for(key in c)c[key][a]&&(aipAPItag.log("Custom Display Bid adjust "+key+" for: "+a+" with value: "+c[key][a]),aipAPItag.displayBidCpm[key]=c[key][a])}aip_pbjs.bidderSettings={rhythmone:{bidCpmAdjustment:function(b,
d){aipAPItag.log("Display Bid adjust for: "+d.bidderCode);return b*aipAPItag.displayBidCpm.rhythmone}},rubicon:{bidCpmAdjustment:function(b,d){aipAPItag.log("Display Bid adjust for: "+d.bidderCode);return b*aipAPItag.displayBidCpm.rubicon}},unruly:{bidCpmAdjustment:function(b,d){aipAPItag.log("Display Bid adjust for: "+d.bidderCode);return b*aipAPItag.displayBidCpm.unruly}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aipAPItag.inIframe()&&aip_pbjs.setConfig({pageUrl:window.location.protocol+
...
aipDisplay.prototype.destroy=function(a){aiptag.settings.iDisableDestroyFunction||googletag.cmd.push(function(){googletag.destroySlots([aipAPItag.adSlot[a]]);aipAPItag.adUnitsLoaded[a]=null;aipAPItag.log("AD SLOT DESTROYED: "+a)})};aipDisplay.prototype.setReload=function(a){void 0!==aipAPItag.adSlots[a]?aipAPItag.adSlots[a].reload=!0:console.warn("***WARNING*** "+a+" is undefined")};
...
adUnits:aipAPItag.adUnits[a],adUnitCodes:[a],bidsBackHandler:function(d){try{aipAPItag.log("Targeting params:"),aipAPItag.log(aip_pbjs.getAdserverTargeting()),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(aip_pbjs.getBidResponses()))}catch(f){aipAPItag.logError(f)}googletag.cmd.push(function(){aiptag.settings.iShowAdblockAdsDisplay&&aipAPItag.gptBlocked?(aipDisplayTag.blocked(a),aipAPItag.queue_ready_display=!0,aipDisplayTag.nextQueue()):(aip_pbjs.setTargetingForGPTAsync([a]),aipAPItag.requestManager[a].prebid=
!0,aipDisplayTag.biddersBack(a),aipAPItag.log("prebid biddersBack - "+a))})}});aiptag.settings.iAmazonAds&&apstag.fetchBids({slots:aipAPItag.adUnitsAps[a],timeout:b},function(d){googletag.cmd.push(function(){apstag.setDisplayBids();aipAPItag.requestManager[a].aps=!0;aipAPItag.log("aps biddersBack - "+a);aipDisplayTag.biddersBack(a)})})})}else aipAPItag.log("AD REFRESH called to soon for: "+a),aipDisplayTag.nextQueue()};
...
aipPlayer.prototype.getBidPrerollTag=function(a){aip_pbjs.que.push(function(){aipAPItag.prerollBidCpm.rhythmone=.8;if(aiptag.settings.sCustomPrerollBidCpmAdjustment){var c=aiptag.settings.sCustomPrerollBidCpmAdjustment;for(key in c)c[key][slotId]&&(aipAPItag.log("Custom Preroll Bid adjust "+key+" for: "+slotId+" with value: "+c[key][slotId]),aipAPItag.prerollBidCpm[key]=c[key][slotId])}aip_pbjs.bidderSettings={rhythmone:{bidCpmAdjustment:function(b,d){aipAPItag.log("Preroll Bid adjust for: "+d.bidderCode);
return b*aipAPItag.prerollBidCpm.rhythmone}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aipAPItag.inIframe()&&aip_pbjs.setConfig({pageUrl:window.location.protocol+"//"+window.location.host});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:1E3,filterSettings:{all:{bidders:"*",filter:"include"}},syncDelay:100},cache:{url:"https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,
...
(document.getElementById("loading-text-aip").style.display="none")}catch(d){aipAPItag.logError(d)}}};aipPlayer.prototype.showCloseButton=function(){try{document.getElementById("aipVideoAdUiCloseButton").style.display="inline"}catch(a){aipAPItag.logError(a)}};aipPlayer.prototype.showSkipButton=function(){try{document.getElementById("aipVideoAdUiSkipButton").style.display="inline"}catch(a){aipAPItag.logError(a)}};
...
aipPlayer.prototype.requestAd=function(a,c,b,d){null==aipAPItag.aipAds&&(b("LOADED FIRST TIME"),aipAPItag.aipAds=new AipAds(a,a.aipConfig.PREROLL_CONTAINER,a.aipConfig.PREROLL_CONTAINER,d));try{aipAPItag.aipAds.requestAds(c,b),a.aipConfig.PREROLL_ELEM.style.display="block"}catch(f){b("EXCEPTION",{name:f.name,message:f.message,stack:f.stack}),a.aipComplete("ad-exception")}};
function AipAds(a,c,b,d){function f(){aipAPItag.sendEvent("video-ad-paused");a.addAipPauseButton();try{document.getElementById("aipPauseButtonContainer").addEventListener("click",g)}catch(e){aipAPItag.logError(e)}}function g(){aipAPItag.sendEvent("video-ad-unpaused");r.resume();try{document.getElementById("aipPauseButtonContainer").style.display="none"}catch(l){aipAPItag.logError(l)}try{document.getElementById("aipPauseButtonContainer").removeEventListener("click",g)}catch(l){aipAPItag.logError(l)}try{var e=
document.getElementById("aipPauseButtonContainer");e.parentNode.removeChild(e)}catch(l){aipAPItag.logError(l)}}function p(){aipAPItag.sendEvent("video-ad-resumed")}function m(e){z("EXCEPTION",{name:e.name,message:e.message,stack:e.stack})}function h(e){var l="",q="",w="";try{l=e.getAd().getContentType(),q=e.getAd().getMinSuggestedDuration(),w=e.getAd().getCreativeId(),prerollSkipTimeOffset=e.getAd().getSkipTimeOffset()}catch(D){m(D)}z("CONTENT_PAUSE_REQUESTED",{contentType:l,creativeId:w,minSuggestedDuration:q})}
function n(e){try{aipAPItag.log("Preroll details:\nAdID:"+e.getAd().getAdId()+"\nAdSystem: "+e.getAd().getAdSystem()+"\ngetAdvertiserName: "+e.getAd().getAdvertiserName()+"\nCreativeAdID: "+e.getAd().getCreativeAdId()+"\nCreativeID: "+e.getAd().getCreativeId()+"\nDescription: "+e.getAd().getDescription()+"\nDuration: "+e.getAd().getDuration()+"\nTitle: "+e.getAd().getTitle()+"\nAdPosition:"+e.getAd().getAdPodInfo().getAdPosition()+"\nTotalAds:"+e.getAd().getAdPodInfo().getTotalAds()+"\nMaxDuration:"+
e.getAd().getAdPodInfo().getMaxDuration()+"\nPodIndex:"+e.getAd().getAdPodInfo().getPodIndex())}catch(l){}G();b.style.display="block";a.showLoading(!1);a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();try{aipAPItag.forceRedraw(document.getElementById(a.aipConfig.PREROLL_ELEM_ID))}catch(l){aipAPItag.logError(l)}if(d)try{z("MediaUrl: "+e.getAd().getMediaUrl()+"; AdvertiserName: "+e.getAd().getAdvertiserName()+"; Description: "+e.getAd().getDescription()+"; Title: "+e.getAd().getTitle())}catch(l){m(l)}z("STARTED");
aipAPItag.sendEvent("video-ad-started");aiptag.settings.iSkipButtonTimeout&&(aipAPItag.showSkipButtonTimer=setTimeout(function(){a.showSkipButton();try{document.getElementById("aipVideoAdUiSkipButton").onclick=function(){r.skip()}}catch(l){aipAPItag.logError(l)}},aiptag.settings.iSkipButtonTimeout))}function t(e){try{var l=e%60;return u(Math.floor(e/60),1)+":"+u(l,2)}catch(q){return e}}function u(e,l){try{var q="000000000"+e;return q.substr(q.length-l)}catch(w){return e}}function v(e){try{var l=e.getAdData();
if(30<parseInt(l.duration)){var q=30-parseInt(l.currentTime);document.getElementById("duration-text-aip").innerHTML=q+"s to close";0>=q&&(document.getElementById("duration-text-aip").innerHTML="",a.showCloseButton(),document.getElementById("aipVideoAdUiCloseButton").onclick=function(){r.skip()})}else document.getElementById("duration-text-aip").innerHTML=t(parseInt(l.currentTime))+" / "+t(parseInt(l.duration))}catch(w){}}function y(){C.contentComplete();r&&r.destroy();z("CONTENT_RESUME_REQUESTED");
E=!1;H("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}function x(e){G();z(e.getError());C.contentComplete();r&&r.destroy();var l=(new Date).getTime()-J;1012==e.getError().getErrorCode()&&0<=l&&800>l?(z("AD BLOCKED",{timeElapsed:l}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock"),e="user-has-adblock"):e.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==e.getError().getErrorCode()&&e.getError().getInnerError()&&
"Error: No ads available"==e.getError().getInnerError().message?(z("NO ADS",{errorCode:e.getError().getErrorCode(),message:e.getError().getMessage(),innerError:e.getError().getInnerError(),vastErrorCode:e.getError().getVastErrorCode(),timeElapsed:l}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty"),e="video-ad-empty"):(z("ERROR",{errorCode:e.getError().getErrorCode(),message:e.getError().getMessage(),innerError:e.getError().getInnerError(),vastErrorCode:e.getError().getVastErrorCode(),
timeElapsed:l}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"),e="video-ad-error");E=!1;H(e)}function B(){I=!0;E=!1;C.contentComplete();r&&r.destroy();z("TIMEOUT");H("video-ad-timeout");aipAPItag.sendEvent("video-ad-timeout")}function G(){F&&(clearTimeout(F),F=null)}function H(e){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(w){aipAPItag.logError(w)}if(aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer)}catch(w){aipAPItag.logError(w)}try{var l=
document.getElementById("aipBranding");if("undefined"!=typeof l&&null!=l){var q=document.getElementById("aipBranding");q.parentNode.removeChild(q)}}catch(w){aipAPItag.logError(w)}G();a.aipComplete(e)}function K(){a.aipConfig.AD_FULLSCREEN?(windowWidth=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,windowHeight=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight,aiptag.settings.iHideBranding||(windowHeight-=26)):a.aipConfig.AD_FILL?
(windowWidth=a.aipConfig.PREROLL_CONTAINER.clientWidth,windowHeight=a.aipConfig.PREROLL_CONTAINER.clientHeight,aiptag.settings.iHideBranding||(windowHeight-=26)):(windowWidth=c.offsetWidth,windowHeight=c.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}var C,r,E,J,F,I,z=function(){};window.addEventListener("error",function(e){if(E)try{z("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+e.error.toString(),message:e.error.toString(),stack:e.error.stack})}catch(l){aipAPItag.logError(l)}});
(function(){var e=new google.ima.AdDisplayContainer(b);e.initialize();C=new google.ima.AdsLoader(e);C.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);C.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(l){function q(A){return function(){"COMPLETE"==A&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(y,1500));"CLICK"==A&&aipAPItag.sendEvent("video-ad-clicked");"USER_CLOSE"==A&&aipAPItag.sendEvent("video-ad-close");
"LOADED"==A&&(aipAPItag.sendEvent("video-ad-loaded"),aipAPItag.prerollSkipped=!1);"SKIPPED"==A&&(aipAPItag.sendEvent("video-ad-skipped"),aipAPItag.prerollSkipped=!0);if("SKIPPABLE_STATE_CHANGED"==A&&aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer),document.getElementById("aipVideoAdUiSkipButton").style.display="none"}catch(L){aipAPItag.logError(L)}z(A);aipAPItag.log("Preroll status: "+A)}}if(!I){var w=new google.ima.AdsRenderingSettings;w.loadVideoTimeout=12E3;r=
l.getAdsManager(c,w);r.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,x);r.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,h);r.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,y);r.addEventListener(google.ima.AdEvent.Type.STARTED,n);r.addEventListener(google.ima.AdEvent.Type.AD_PROGRESS,v);r.addEventListener(google.ima.AdEvent.Type.SKIPPED,q("SKIPPED"));r.addEventListener(google.ima.AdEvent.Type.CLICK,q("CLICK"));r.addEventListener(google.ima.AdEvent.Type.PAUSED,
f);r.addEventListener(google.ima.AdEvent.Type.RESUMED,p);r.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,q("FIRST_QUARTILE"));r.addEventListener(google.ima.AdEvent.Type.MIDPOINT,q("MIDPOINT"));r.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,q("THIRD_QUARTILE"));r.addEventListener(google.ima.AdEvent.Type.LOADED,q("LOADED"));r.addEventListener(google.ima.AdEvent.Type.COMPLETE,q("COMPLETE"));r.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,q("USER_CLOSE"));r.addEventListener(google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED,
q("SKIPPABLE_STATE_CHANGED"));try{var D=K();a.aipConfig.AD_FULLSCREEN||a.aipConfig.AD_FILL?r.init(D.adWidth,D.adHeight,google.ima.ViewMode.FULLSCREEN):r.init(D.adWidth,D.adHeight,google.ima.ViewMode.NORMAL);r.start()}catch(A){m(A)}}});C.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,x)})();window.addEventListener("resize",function(){if(r&&E)if(a.aipConfig.AD_FULLSCREEN){var e=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,l=document.documentElement.clientHeight||
document.body.clientHeight||window.innerHeight;aiptag.settings.iHideBranding||(l-=26);r.resize(e,l,google.ima.ViewMode.FULLSCREEN)}else a.aipConfig.AD_FILL&&(e=a.aipConfig.PREROLL_CONTAINER.clientWidth,l=a.aipConfig.PREROLL_CONTAINER.clientHeight,aiptag.settings.iHideBranding||(l-=26),r.resize(e,l,google.ima.ViewMode.FULLSCREEN))});this.requestAds=function(e,l){z=l;J=(new Date).getTime();var q=new google.ima.AdsRequest;q.adTagUrl=e;aipAPItag.inIframe()&&(q.pageUrl=window.location.href);var w=K();
q.linearAdSlotWidth=w.adWidth;q.linearAdSlotHeight=w.adHeight;q.nonLinearAdSlotWidth=w.adWidth;q.nonLinearAdSlotHeight=w.adHeight;q.forceNonLinearFullSlot=!0;q.setAdWillAutoPlay(!1);q.setAdWillPlayMuted(!1);C.requestAds(q);F=setTimeout(B,15E3);I=!1;E=!0}}aipAPItag=new aipAPI;aipAPItag.log("aiplib last updated: "+aiptag.settings.sUpdated);aipAPItag.cutomSizeConfig();aipAPItag.initGPT();aipAPItag.setCurrency();aipAPItag.detectBlockedAds();aipAPItag.initGDPR();